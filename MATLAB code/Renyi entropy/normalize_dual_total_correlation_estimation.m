function [normalize_dual_total_correlation,dual_total_correlation] = normalize_dual_total_correlation_estimation(variable,sigma,alpha)
...
% dual_total_correlation_LB = max(mutual_information_collect);
dual_total_correlation_LB = 0;

%% normalize dual total correlation
normalize_dual_total_correlation = (dual_total_correlation - dual_total_correlation_LB)/(H_all - dual_total_correlation_LB);
